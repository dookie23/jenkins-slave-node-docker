...
RUN wget -nv https://get.docker.com/builds/Linux/x86_64/docker-${DOCKER_VERSION}.tgz
RUN tar --strip-components=1 -xvzf docker-${DOCKER_VERSION}.tgz -C /usr/bin/docker
